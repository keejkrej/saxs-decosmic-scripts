...
# Parameters
INPUT_FILE = "80/raw/exp-specman_2_ct_419386.tif"   # Path to the first image in the series
OUTPUT_DIR = "80/processed"             # Output directory
OUTPUT_PREFIX = "80"                    # Output file prefix
