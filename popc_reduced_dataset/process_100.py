...
# Parameters
INPUT_FILE = "100/raw/exp-specman_2_ct_419386.tif"   # Path to the first image in the series
OUTPUT_DIR = "100/processed"             # Output directory
OUTPUT_PREFIX = "100"                    # Output file prefix
