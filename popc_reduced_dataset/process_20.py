...
# Parameters
INPUT_FILE = "20/raw/exp-specman_2_ct_419386.tif"   # Path to the first image in the series
OUTPUT_DIR = "20/processed"             # Output directory
OUTPUT_PREFIX = "20"                    # Output file prefix
