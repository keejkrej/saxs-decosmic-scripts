...
# Parameters
INPUT_FILE = "40/raw/exp-specman_2_ct_419386.tif"   # Path to the first image in the series
OUTPUT_DIR = "40/processed"             # Output directory
OUTPUT_PREFIX = "40"                    # Output file prefix
