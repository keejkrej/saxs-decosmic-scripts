...
# Parameters
INPUT_FILE = "60/raw/exp-specman_2_ct_419386.tif"   # Path to the first image in the series
OUTPUT_DIR = "60/processed"             # Output directory
OUTPUT_PREFIX = "60"                    # Output file prefix
