...
# Parameters
INPUT_FILE = "empty/raw/exp-specman_2_ct_424426.tif"   # Path to the first image in the series
OUTPUT_DIR = "empty/processed"             # Output directory
OUTPUT_PREFIX = "empty"                    # Output file prefix
